...
def create_aaep(cobra_md):
    global aaep_name
    aaep_name = GO_CONFIG.bladeserver['namebase'] + '-aaep'
...
def create_int_polgrp(cobra_md):
    global intgrp_name
    intgrp_name = GO_CONFIG.bladeserver['namebase'] + '-intgrp'
...
def create_int_profile(cobra_md):
    global intpro_name
    intpro_name = GO_CONFIG.bladeserver['namebase'] + '-int_pro'
    sel_name = GO_CONFIG.bladeserver['namebase'] + '-int-sel'
...
def create_sw_profile(cobra_md, leafs):
    swproname = GO_CONFIG.bladeserver['namebase'] + '-sw_pro'
...
def aci_build_esx(cobra_md, session, config):
